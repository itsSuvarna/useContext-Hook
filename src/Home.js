...
function Home() {
  ...
  function handleDecreaseFontSize() {
    ...
    //this function is called when user upload image.
    //It reads the uploaded file using the "FileReader" API and creates an "img" element with uploaded image.
    //It then inserts the image at the current cursor pointer using "insertNode" method of the "Range" API.
